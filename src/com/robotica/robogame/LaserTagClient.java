...
public class LaserTagClient extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ammo = (TextView) findViewById(R.id.ammo2);
        healthing = (TextView) findViewById(R.id.health2);
        energy = (TextView) findViewById(R.id.energyText2);
        speed = (TextView) findViewById(R.id.speedText2);
                   ...
                   */ 
                    /*    if(remaningAmmo == 0) {
                        ...
                        if(speedIncrease)
                         ...
                         try {
 //                            in = new BufferedReader(new InputStreamReader(socket.getInputStream()));
                        	 String line = in.readLine() + counter;
                        	 if(line != null)
                                     ...
                                     public void run() {
                                         ...
                                         if(remainingHealth == 0) {
                                        	 ...
                                        	 //setNewHighScore(raceTime);
                             				 startActivity(new Intent(LaserTagClient.this, GameOverActivity.class));
...
//                             }
                            	 ...
                            	 handler.post(new Runnable() {
                                     ...
                                     public void run() {
                                    	currentSpeed += 30;
                                    	speedIncrease = true;
                                    	speedIncreaseTime = System.currentTimeMillis();
                            	 ...
                            	 handler.post(new Runnable() {
                                     ...
                                     public void run() {
                                    	currentSpeed -= 30;
                                    	speedDecrease = true;
                                    	speedDecreaseTime = System.currentTimeMillis();
                                        speed.setText(Integer.toString(currentSpeed));
                                     }
                                 });
                             } 
