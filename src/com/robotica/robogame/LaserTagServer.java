...
public class LaserTagServer extends Activity implements SensorEventListener {
                                 ...
                                 public void run() {
                                     ...
                                     if(remainingHealth == 0) {
                                    	 ...
                                    	 //setNewHighScore(raceTime);
                         				 startActivity(new Intent(LaserTagServer.this, GameOverActivity.class));
